...
<!-- Please read the https://github.com/linuxserver/docker-calibre/blob/arch/.github/CONTRIBUTING.md -->
...
[![Jenkins Build](https://img.shields.io/jenkins/build?labelColor=555555&logoColor=ffffff&style=for-the-badge&jobUrl=https%3A%2F%2Fci.linuxserver.io%2Fjob%2FDocker-Pipeline-Builders%2Fjob%2Fdocker-calibre%2Fjob%2Farch%2F&logo=jenkins)](https://ci.linuxserver.io/job/Docker-Pipeline-Builders/job/docker-calibre/job/arch/)
...
Simply pulling `lscr.io/linuxserver/calibre:arch` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
docker run -d \
  ...
  --restart unless-stopped \
  lscr.io/linuxserver/calibre:arch
```
...
* image version number
  * `docker inspect -f '{{ index .Config.Labels "build_version" }}' lscr.io/linuxserver/calibre:arch`
...
* Update the image: `docker pull lscr.io/linuxserver/calibre:arch`
...
docker build \
  --no-cache \
  --pull \
  -t lscr.io/linuxserver/calibre:arch .
```
